...
from Game_logic.data import player, list_monster, list_objects, list_weapon, list_event, list_shop
...
def launch_screen():  
    ...
    while player_choice != True:
        ...
        if player_input == 1:
            ...
            start_game(player, list_monster, list_objects, list_weapon, list_event, list_shop)
            
        elif player_input == 2:
            # load the save
            loaded_player, loaded_monsters, loaded_objects, loaded_weapon, loaded_event, loaded_shop = load()
            if loaded_player:
                ...
                load_list_shop = loaded_shop
                start_game(load_player, load_list_monster, load_list_objects, load_list_weapon, load_list_event, load_list_shop)
